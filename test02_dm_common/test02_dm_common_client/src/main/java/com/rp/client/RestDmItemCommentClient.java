...
import com.rp.fallback.DmItemCommentClientFallBack;
...
* Created by dm
*/
@FeignClient(name = "test02-dm-item-provider", configuration = DmConfiguration.class, fallback = DmItemCommentClientFallBack.class)
