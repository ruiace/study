...
import com.rp.fallback.DmImageClientFallBack;
...
@FeignClient(name = "test02-dm-base-provider", configuration = DmConfiguration.class, fallback = DmImageClientFallBack.class)
