...
import com.rp.fallback.${table.className}ClientFallBack;
...
*/
@FeignClient(name = "dm-scheduler-provider", configuration = DmConfiguration.class, fallback = ${table.className}ClientFallBack.class)
